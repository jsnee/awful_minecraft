...
execute if data entity @s Inventory[{Slot:3b}] run title @s title "Geez"
execute if data entity @s Inventory[{Slot:3b}] run title @s subtitle "You can't remember the last time you laid down..."
