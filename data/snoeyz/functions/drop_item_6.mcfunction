...
execute if data entity @s Inventory[{Slot:6b}] run title @s title "Feet Heavy"
execute if data entity @s Inventory[{Slot:6b}] run title @s subtitle "You trudge on, despite your exhaustion"
