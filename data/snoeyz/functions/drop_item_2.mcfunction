...
execute if data entity @s Inventory[{Slot:2b}] run title @s title "You Yawn"
execute if data entity @s Inventory[{Slot:2b}] run title @s subtitle "As you fumble with your belongings..."
